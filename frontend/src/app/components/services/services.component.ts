    ...
    return [
      {
        ...
        items: [
          ...
          },
          {
            ...
            endpoint: '/terrane/ows',
            operations: ['service=WMS / WFS / WCS / WPS / CSW'],
            testUrl: '/terrane/ows?service=WMS&version=1.3.0&request=GetCapabilities',
            versions: [
              {
                version: 'WMS 1.3.0',
                url: '/terrane/ows?service=WMS&version=1.3.0&request=GetCapabilities',
              },
              {
                version: 'WFS 2.0.0',
                url: '/terrane/ows?service=WFS&version=2.0.0&request=GetCapabilities',
              },
              {
                version: 'WCS 2.0.1',
                url: '/terrane/ows?service=WCS&version=2.0.1&request=GetCapabilities',
              },
              {
                version: 'WPS 1.0.0',
                url: '/terrane/ows?service=WPS&version=1.0.0&request=GetCapabilities',
              },
              {
                version: 'CSW 2.0.2',
                url: '/terrane/ows?service=CSW&version=2.0.2&request=GetCapabilities',
              },
            ],
          },
        ],
        ...
        items: [
          {
            ...
            endpoint: '/terrane/gwc/service/tms/1.0.0',
            operations: ['TileMapService', 'TileMap', 'Tile'],
            testUrl: '/terrane/gwc/service/tms/1.0.0',
            versions: [{ version: '1.0.0', url: '/terrane/gwc/service/tms/1.0.0' }],
          },
          {
            id: 'wmsc',
            name: 'WMS-C',
            ...
            endpoint: '/terrane/gwc/service/wms',
            operations: ['GetCapabilities', 'GetMap'],
            testUrl: '/terrane/gwc/service/wms?SERVICE=WMS&REQUEST=GetCapabilities',
            versions: [
              {
                version: '1.1.1',
                url: '/terrane/gwc/service/wms?SERVICE=WMS&REQUEST=GetCapabilities',
              },
            ],
          },
          {
            ...
            endpoint: '/terrane/mvt/{layer}/{z}/{x}/{y}',
          ...
          },
          {
            ...
            endpoint: '/terrane/tiles/{layer}/{z}/{x}/{y}',

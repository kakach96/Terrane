...
pub fn build_capabilities(
    ...
    let capabilities = WmtsCapabilities {
        ...
        service_identification: ServiceIdentification {
            title: "Terrane WMTS".to_string(),
            abstract_text: "Web Map Tile Service powered by Terrane".to_string(),
            keywords: Keywords {
                keyword: vec![
                    "WMTS".to_string(),
                    "Tile".to_string(),
